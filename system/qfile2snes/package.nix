...
stdenv.mkDerivation (finalAttrs: {
  ...
  sourceRoot = "${finalAttrs.src.name}/QFile2Snes";

  installPhase = ''
    runHook preInstall
    ls
    cd QFile2Snes
    installBin QFile2Snes
    installManPage --name QFile2Snes.1 QFile2Snes.manpage.1
    install -Dm644 icon50x50.png $out/share/icons/hicolor/128x128/apps/fr.nyo.QFile2Snes.png
    install -Dm644 QFile2Snes.desktop $out/share/applications/fr.nyo.QFile2Snes.desktop
    cd ..
